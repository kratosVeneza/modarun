...
export default function Header({ userEmail }: { userEmail?: string }) {
  ...
  const navLinks = [
    ...
    { href: "/meus-encontros", label: "Meus treinos" },
        ...
        <div className="flex items-center gap-2">
          {userEmail ? (
            <div className="hidden items-center gap-2 sm:flex">
              <span className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-500 max-w-[160px] truncate">
                {userEmail}
              </span>
              <button
