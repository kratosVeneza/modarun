      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white px-8 py-8 shadow-xl shadow-slate-200/60">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-500">Junte-se à comunidade de corredores da Moda Run.</p>
          </div>
          <AuthForm mode="signup" />
        </div>
        <p className="mt-6 text-center text-xs text-slate-400">Cadastro gratuito. Sem spam.</p>
      </div>
    </main>
  );
}
